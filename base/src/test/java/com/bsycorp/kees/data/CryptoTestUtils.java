...
public final class CryptoTestUtils {
    ...
    public static class DecryptionService {
        ...
        public DecryptionService(
                String decryptorPassword,
                byte[] decryptorPrivateKey,
                byte[] decryptorPublicKey,
                String signingUserId,
                byte[] signingPublicKey) throws IOException, PGPException {
            this.signingUserId = signingUserId;
            keyring = KeyringConfigs.forGpgExportedKeys(KeyringConfigCallbacks.withPassword(decryptorPassword));
            keyring.addSecretKey(decryptorPrivateKey);
            keyring.addPublicKey(decryptorPublicKey);
