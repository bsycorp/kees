...
public class DeterministicDataProvider extends AbstractDataProvider {
    ...
    private static final ArrayList<String[]> encodedPrecalculatedValues = new ArrayList<>();
    ...
    static {
        ...
        encodedPrecalculatedValues.add(new String[]{
    ...
    public byte[] generateRaw(SecretTypeEnum type, String annotationName, int size) {
        ...
        byte[] result = super.generateRaw(type, annotationName, size);
        return result;
    }
    ...
    public Object[] generatePairedRaw(SecretTypeEnum type, String annotationName, int size) {
            ...
            String[] values = encodedPrecalculatedValues.get(Math.abs(rootAnnotationName.hashCode()) % encodedPrecalculatedValues.size());
            return new Object[]{
